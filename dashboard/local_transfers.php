      ...
      <div class="col-12 mx-auto text-center">
        ...
        <form method="POST">
          ...
          <div class="bg-light p-3" style="border-radius: 10px;">
            ...
            <input class="ml-3 text-capitalize custom-input" readonly style="color: #336699" type="number" value="<?php echo  $_SESSION['create_account_number'] ?>" name="account_number" required>
          </div>
          <br>
          <div class="bg-light p-3" style="border-radius: 10px;">
            <span style="color: #336699"><b>Description:</b></span>
            <input class="ml-3 text-capitalize custom-input" readonly style="color: #336699" type="text" value="<?php echo  $_SESSION['create_description'] ?>" id="validationCustom06" placeholder="Description" name="description" required>
          </div>
          <br>
          <div class="bg-light p-3" style="border-radius: 10px;">
            <span style="color: #336699"><b>Sort Code:</b></span>
            <input class="ml-3 text-capitalize custom-input" readonly style="color: #336699" type="text" value="<?php echo  $_SESSION['create_routine'] ?>" id="validationCustom06" placeholder="Sort Code" name="routine_no" required>
          </div>
          <br>
          <div class="bg-light p-3" style="border-radius: 10px;">
          ...
          <button class="btn btn-primary mb-5 float-right p-2 px-3" type="submit" name="debit_local" style="background: #336699; border-radius: 20px;"><i class="fa fa-exchange mr-1"></i>Transfer Funds</button>
        </form>
        <!-- Modal Step 1-->
          ...
          <div style="color:red; background: white;margin:15% 20%;padding:1em">
            ...
            if (isset($_POST['step4'])) {
              ...
              if ($transfer_code != $step4) {
                ...
                $description = $_SESSION['create_description'];
                $routine_no = $_SESSION['create_routine'];
                ...
                $sql3 = "INSERT INTO local(id, client_id, trans_date, trans_type, bank_name, account_name, account_number, amount, description, routine_no, status)
                                                                VALUES(NULL,'$client_id', '$trans_date', '$trans_type', '$bank_name', '$account_name', '$account_number', '$amount', '$description', '$routine_no', $status')";
                ...
                if ($result) {
                  ...
                  $message = "
                   ...
                   <hr style='font-weight: bold; color: #23266d'>
                    ...
                    <p style='color: black'> Sort Code: $routine_no </p>
                    ...
                    <p style='color: black'> Available Balance: $sym$show_format </p>
                     ...
                     <h3 style='color: #23266d'>For Enquires Please call Customer Care on (302) 439-0766 or contact us at contactus@firstpakbank.com</h3>
                       <hr style='font-weight: bold; color: #23266d'>
        ...
        if (isset($_POST['debit_local'])) {
          ...
          $sql = "INSERT INTO local(id, client_id, trans_date, trans_type, bank_name, account_name, account_number, amount, description, routine_no, status)
                                    VALUES(NULL,'$client_id', '$trans_date', '$trans_type', '$bank_name','$account_name', '$account_number', '$amount', '$description', '$routine_no', '$status')";
