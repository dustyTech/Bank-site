...
<head>
	...
	<title>Internet Banking | FirstPak Bank</title>
	<!-- Bootstrap -->
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699;">
					<img src="images/verification/document-capture.png" class="manage-height">
					<div class="holdWriteUp">
						<h3 class="text-center carryTop text_white">
							Internet Banking
						</h3>
						<p class="text-center carryBottom text_white">
							FirstPak Bank Online Banking Service gives you unrestricted and secure access to your account, anytime, anywhere on your computer, tablet, smart phones or any internet-enabled devices. It is your bank on the go!
						</p>
					</div>
				</div>
			</div>
								...
								<div class="col-md-12 main_00">
									<div class="row">
										...
										<div class="col-md-10 col-md-offset-1 text-left" style="height: auto;  background: #F6F6F6;">
											...
											<p>
												Move money to your friends and family whether they have accounts with FirstPak Bank or other banks globally. Paying those bills cannot be easier with Internet Banking. Payments are usually processed by Faster Payments but we also allow you to make payments by CHAPS online!
											</p>
									...
									<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
										...
										<div class="panel panel-default">
											<div class="panel-heading style-none" role="tab" id="headingTwo">
												<h4 class="panel-title">
													<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
														Can I view all my accounts with FirstPak Bank using one Internet Banking login ID?
											...
											<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
												<div class="panel-body">
													<p>
														Yes, when you enroll for FirstPak Bank Internet Banking Service, you Can specify which accounts you want access to over the internet and can have access to all of them using one single user ID.
													</p>
												</div>
											</div>
										</div>
										<div class="panel panel-default">
											...
											<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
												<div class="panel-body">
													<p> Internet Banking is protected with the best-in-class security technology. To further protect your profile, do not share your credentials with anyone, do not click on any suspicious link, when you are in doubt, always contact contactus@firstpakbank.com
													</p>
												</div>
											</div>
										</div>
							...
							<div class="text-center col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
								<aside class="widget widget-content">
									<div class="widget-body" style="margin-top: 20px;">
										...
										<div class="my-link">
											<ul>
												<li><a href="home.php" class="text_white">Home</a></li>
