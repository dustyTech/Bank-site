...
<head>
  ...
  <title>Debit Card | FirstPak Bank</title>
  <!-- Bootstrap -->
          ...
          <div class="col-md-6 hidden-sm hidden-xs">
            <div class="left-content">
              <div class="section-half-thumb">
                <img src="images/partnership/Capital%20Bank-atm.jpg" class="img-responsive" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div>
              ...
              <p class="subtext">The (302) 439-0766 Bank MasterCard® Debit Card is an international payment card denominated in EU Currency. It offers you convenience and security by combining the worldwide acceptance and benefits of MasterCard® with a debit card. This ensures funds are debited directly from your account giving you full control of your finances at home and abroad.</p>
              <p>FirstPak Bank Debit Card provides you with a relatively convenient and secure way to make payments for goods and services at over 29 million retail locations, on the internet and at over 1.4 million ATMs in over 251 countries around the world – wherever you see the MasterCard® symbol.
              </p>
