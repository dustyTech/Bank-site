...
<head>
  ...
  <title>Home | FirstPak Bank</title>
  <!-- Bootstrap -->
  ...
  <!--My Custom Css -->
  <a href="dashboard/international_transfer.php"></a>
...
<body style=" overflow-x: hidden;">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
                <a class="hidden-lg hidden-md" href="login.php" style="color: white;">Login</a>
              </li>
  ...
  <!-- Banner End -->
  <div class="container hidden-sm hidden-md hidden-lg" style="background: url(images/slider/mobile_slider.png); background-repeat: no-repeat; background-size: cover; ">
    <div class="row">
      <div class="col-xs-12" style="background:#336699; padding-top: 70px; ">
      </div>
      <div class="col-xs-12 text-center" style="background:#336699; padding-top:20px; ">
        <small class="text_white text-center">Welcome to FirstPak Bank</small>
      </div>
      <div class="col-xs-12" style="background:#336699; padding-bottom:10px;">
        <h5 class="text_white text-center">What will you like to do? </h5>
      </div>
      <div class="col-xs-6" style="background:#336699; padding-left: 0px; padding-right: 0px; height:140px; border: solid 1px white; ">
      ...
      <div class="col-xs-6" style="background:#336699; padding-left: 0px; padding-right: 0px;  height:140px; border: solid 1px white;">
        <div class="text_white text-center" style="padding: 30px;">
          <a class="no_color_on_hover" target="_blank" href="register.php" style="width: 100%; height: 100%;" class="no_color_on_hover">
            Open Account
            <br><i class="fa fa-key fa-2x"></i>
          </a>
        </div>
      </div>
      <div class="col-xs-6" style="background:#336699;  height:140px; padding-left: 0px; padding-right: 0px; border: solid 1px white;">
      ...
      <div class="col-xs-6" style="background:#336699;  height:140px; padding-left: 0px; padding-right: 0px; border: solid 1px white;">
        <a class="no_text_deco" href="about.php">
          <div class="text_white text-center" style="padding: 30px;">
            Locate A Branch
  ...
  <div class="container-fluid">
    <div id="theNext" class="info-box section-padding-me row" style="background: url(images/security/security__info-bg.png); background-repeat: no-repeat; background-size: 100% 100%; padding-top:0px; padding-bottom:50px;">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6 col-md-offset-3" style="margin-top:20px;">
                <div class="section-heading text-center">
                  <h4 class="title" style="color:#336699; ">Innovative <span style="color:#E3AF15;">Banking Products</span></h4>
                ...
                <div class="white-board">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4  zero-padding-right m-topm">
                      <img src="images/security/regulated_broker.png" class="img-responsive">
                    </div>
              ...
              <div class="col-md-6" style="margin-top: 20px;">
                <div class="white-board">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4  zero-padding-right m-topm">
                      <img src="images/security/saccf.png" class="img-responsive">
                    </div>
                    <div class="col-md-9 col-sm-9 col-xs-12 zero-padding-left m-topn">
                      <div class="row">
                        <h5 class="col-md-12 zero-padding-left" style="color:#336699; ">
              ...
              <div class="col-md-6" style="margin-top: 20px;">
                <div class="white-board">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4  zero-padding-right m-topm">
                      <img src="images/security/nbp.png" class="img-responsive">
                    </div>
                    <div class="col-md-9 col-sm-9 col-xs-12 zero-padding-left m-topn">
                      <div class="row">
                        <h5 class="col-md-12 zero-padding-left" style="color:#336699; ">
              ...
              <div class="col-md-6" style="margin-top: 20px;">
                <div class="white-board">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4 zero-padding-right m-topm">
                      <img src="images/security/mfc.png" class="img-responsive">
                    </div>
              ...
              <div class="col-md-6" style="margin-top: 20px;">
                <div class="white-board">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4 zero-padding-right m-topm">
                      <img src="images/security/ffc.png" class="img-responsive">
                    </div>
                    <div class="col-md-9 col-sm-9 col-xs-12 zero-padding-left" style="padding-bottom:20px;">
                      <div class="row">
                        <h5 class="col-md-12 zero-padding-left m-topn" style="color:#336699; ">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="left-content">
              <img src="images/about/image-content-1.jpg" class="img-responsive" alt="">
            </div>
          </div>
          <div class="col-sm-6">
  ...
  <!-- CTA Simple -->
  <div class="container-fluid">
    <div class="cta cta-simple row" style="background: #336699;">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="cta-button text-center">
              <a href="register.php" class="button button-3x" style="background: #336699; color:white; border: white 1px solid;">Get Started</a>
            </div>
          </div>
            ...
            <div class="col-md-4 col-sm-4">
              <div class="feature-box-4-grid">
                <div class="feature-box text-center">
                  ...
                  <!--<a href="#" class="button button-3x" style="background: #336699; color:white; border: white 1px solid;">Signup</a>-->
                </div>
              </div>
            </div>
            <div class="col-md-4 col-sm-4">
    ...
    <div class="service section-padding row" style="background:#f2f5fb;">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <div class="section-heading text-center">
              <h3 class="title"><span style="color: #336699;">Award-Winning</span> Bank</h3>
          ...
          <div class="margin-balance">
            <div class="col-md-3 col-sm-3">
              <div style="background: transparent;">
                <div class="feature-box text-center">
                  <h6 class="title" style="color: #336699;">Savings Account</h6>
            ...
            <div class="col-md-3 col-sm-3 ">
              <div class="feature-box-4-grid1 " style="background: transparent;">
                <div class="feature-box text-center">
                  <h6 class="title" style="color: #336699;">Current Account</h6>
                  <p class="subtext">
            ...
            <div class="col-md-3 col-sm-3">
              <div class="feature-box-4-grid1" style="background: transparent;">
                <div class="feature-box text-center">
                  <h6 class="title" style="color: #336699;">Off Shore/Joint Account</h6>
                  <p class="subtext">
            ...
            <div class="col-md-3 col-sm-3">
              <div class="feature-box-4-grid1" style="background: transparent;">
                <div class="feature-box text-center">
                  <h6 class="title" style="color: #336699;">Fixed Account</h6>
                  <p class="subtext">
            ...
            <div class="col-md-12 col-sm-12 text-center">
              <a href="register.php" class="button button-3x" style="background: #336699; color:white; border: white 1px solid;">Join Us</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- security of funds -->
  <div class="container-fluid">
    <div class="service section-padding row" style="background:#336699;">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <div class="section-heading text-center">
              <h3 class="title text_white">Security of Funds</h3>
              <p class="subtext text_white">Your funds are fully secured when you bank with FirstPak Bank.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="margin-balance">
              ...
              <a style="text-decoration:none; width: 100%; height: 100%;">
                <div class="feature-box-4-grid">
                  <div class="feature-box text-center">
                    ...
                    <img src="images/product/license.png" style="width:20%; margin-left: 40%; margin-right: 40%;">
            ...
            <div class="col-md-12 col-sm-12 text-center">
              <a href="about.php" class="button button-3x" style="background: #336699; color:white; border: white 1px solid;">Read More About Us</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-12" style="position: relative;">
        <img src="images/slider/apbg.png" class="checkHeight" style="width: 100%;">
        <div style="z-index:10;" class="mobile_incribe">

          <div class="row">

            <h4 class="col-md-12 hazie_mobile_app" style="color:black; font-weight:bold;">FirstPak Bank mobile App</h4>
            <p class="col-md-12 hidden-xs">Stay connected and get instant notifications!</p>
            <div class="col-md-6 col-xs-6" style="padding-right: 0px; z-index:10;"><img src="images/tab/googleapp.png" class="img-responsive"></div>
            <div class="col-md-6 col-xs-6" style="padding-left: 0px; z-index:10;"><img src="images/tab/googleapp.png" class="img-responsive"></div>
          </div>
  ...
  <div class="container-fluid">
    <div class="cta cta-simple row" style="background: white; padding-top: 30px;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <h5 class="title" style="color:#336699;">Send Platform Link to Your Mobile: </h5>
          </div>
          <div class="col-md-3">

            <div class="form-group">

              <select class="form-control theForm1" id="smsPhoneCountryCode" name="PhoneCountryCode" value="44" style="color:#336699;">
          ...
          <div class="col-md-2">
            <div class="cta-button text-right">
              <a class="button button-3x" style="background: #336699; color:white; border: white 1px solid;">Send Link</a>
            </div>
          </div>
          ...
          <div class="col-md-5 col-sm-5 col-xs-12 text-center" style="margin-top: 10px;">
            ...
            <ul style="display: inline-block;" style="margin-top: 10px;">
              <li style="display: inline;" class="text-center">
                <a href="www.facebook.php" class="holdSocial text-center">
                  <i class="fa fa-facebook" style="color:white;"></i>
                </a>
              </li>&nbsp;
              <li style="display: inline;" class="text-center">
                <a href="www.google.php" class="holdSocial text-center">
      ...
      <div id="signInModal" class="my_modal2 hideModal " style="background: url(images/slider/mobile_slider.png); background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center text_white" style="margin-top: 10px;">
            Not Yet Registered?<br><a target="_blank" href="register.php" class="no_color_on_hover" style="text-decoration: underline;">Enroll Now!</a>
          </div>
