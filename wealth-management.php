...
<head>
  ...
  <title>Wealth Management | FirstPak Bank</title>
  <!-- Bootstrap -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699; ">
          <img src="images/partnership/cpa-af-bg.jpg" style="width: 100%; height: 100%;">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="cta-button text-right">
              <a href="contact-us.php" class="button primary-bg button-3x">Get a Quote</a>
            </div>
          </div>
        </div>
      </div>
