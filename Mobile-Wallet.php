...
<head>
  ...
  <title>Mobile Wallet | FirstPak Bank</title>
  <!-- Bootstrap -->
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1" style="margin-top: 40px;">
            <div class="section-heading text-left">
              ...
              <p class="subtext"><b>Introducing Mobile Wallet, a safe and easy way to make payments with your FirstPak Bank Debit and Credit Cards.</b>
              </p>
            </div>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-10 col-md-offset-1">
                  <div class="section-heading text-left">
                    ...
                    <p></p>
                    <p class="subtext">
                      <a href="register.php" class="button button-2x primary-bg button-arrow button-radius">Apply Now &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </p>
