        ...
        <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699; ">
          ...
          <div class="holdWriteUp">
            ...
            <p class="text-center carryBottom text_white">
              FirstPak Bank makes digital payments and transfers easy with various credit, debit and ATM card options to suit your needs. You'll appreciate the anytime access and other convenient features of these cards.
            </p>
          ...
          <div class="col-md-6 hidden-sm hidden-xs">
            <div class="left-content">
              <div class="section-half-thumb">
                <img src="images/partnership/Interex%20Finance-atm.jpg" class="img-responsive" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div>
              ...
              <br>
              <a href="about.php" class="button button-5x covered_but text_white control-btn-text" style="background-color: #336699 !important; font-size: 14px !important;">
                ATM Locator
              </a>
            </div>
          </div>
        ...
        <div class="footer-copyright">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <div class="copyright">
                  <p> <a href="#"> FirstPak Bank </a> © 2020 </span>. All rights reserved.</p>
