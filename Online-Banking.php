...
<head>
  ...
  <title>Online Banking | FirstPak Bank</title>
  <!-- Bootstrap -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699; ">
          <img src="images/Prepaid%20Card/prepaid-card.png" style="width: 100%; height: 100%;">
          <div class="holdWriteUp">
            <h3 class="text-center carryTop text_white">
              Online Banking
            </h3>
            <p class="text-center carryBottom text_white">
              When it comes to managing your personal or business accounts, you'll be able to quickly pay bills, transfer money, apply for certain loans and much more through Rowayton Capital Online Banking.
            </p>
              ...
              <div class="row">
                <div class="col-md-10 col-md-offset-1 text-left">
                  ...
                  <ul style="margin-top: 20px;">
                    ...
                    <li dir="LTR">&#8226;<strong>&nbsp;</strong>Transfer funds between your Rowayton Capital Bank and outside accounts</li>
                ...
                <div class="col-md-6 col-sm-6">
                  <div style="background: transparent;">
                    <div class="feature-box text-center">
                      ...
                      <p class="subtext">Stop worrying over lost or late payments. Be confident it gets there on-time, every time with Automatic Payments from Rowayton Capital Bank Online Banking.</p>
                      <a href="about.php" class="button button-2x primary-bg button-arrow button-radius">Read More &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="feature-box-4-grid1 " style="background: transparent;">
                    <div class="feature-box text-center">
                      ...
                      <a href="debit-card.php" class="button button-2x primary-bg button-arrow button-radius">Read More &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="feature-box-4-grid1" style="background: transparent;">
                    <div class="feature-box text-center">
                      ...
                      <a href="e-statements.php" class="button button-2x primary-bg button-arrow button-radius">Read More &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
      ...
      <div class="row">
        ...
        <div id="forGetPass" class="my_modal2 hideModal " style="background: url(images/slider/mobile_slider.png); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center" style="margin-top: 10px;">
              <a href="register.php" onClick="callSignInModal()" class="no_color_on_hover">Login</a>
            </div>
