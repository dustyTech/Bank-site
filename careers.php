...
<head>
  ...
  <title>Careers | FirstPak Bank</title>
  <!-- Bootstrap -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699; ">
          <img src="images/partnership/cpa-af-bg.jpg" style="width: 100%; height: 100%;" data-pagespeed-url-hash="4011159537" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          <div class="holdWriteUp">
            <h3 class="text-center carryTop text_white">
              Careers
            </h3>
            <p class="text-center carryBottom text_white">
              FirstPak Bank is the international financial organization - and one of Europe’s leading banks
            </p>
        ...
        <div class="row">
            ...
            <div class="left-content">
              <div class="image-content image-content-3">
                <div class="section-heading">
                  ...
                  <p class="subtext">Everyone who works at FirstPak Bank works in partnership with their colleagues, lending support and encouragement
                  ...
                  <br>
                  <p>
                    If you think we could make a good fit, then please e-mail your CV to <a href="contactus@firstpakbank.com">contactus@ostonbank.com</a>
                  </p>
                  <br>
                  <p>
          ...
          <div class="col-sm-6">
            <div class="right-content">
              <img src="images/about/image-content-1_1.jpg" class="img-responsive" alt="" data-pagespeed-url-hash="3640630981" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
            </div>
          </div>
        </div>
      </div>
...
<div class="container-fluid">
   <div class="cta cta-simple row" style="background:#151D28;">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h5 class="title text_white">Don’t Miss our future updates. Get in touch for next...</h5>
          </div>
          <div class="col-md-5">
            <div class="cta-form">
              <form action="#" method="post" class="form-inline flexo-subscription">
                <div class="form-group">
                  <input type="email" class="form-control" placeholder="Enter your mail here...">
                </div>
        ...
        <div class="footer-copyright">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <div class="copyright">
                  <p> <a href="#">FirstPak Bank</a> © 2020 <span class="date_holder"></span>. All rights reserved.</p>
