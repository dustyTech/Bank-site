...
<html>
    <head>
        ...
        <title>Delete Local Transaction </title>
                ...
                <tbody>
                   ...
                   <td>-
                    ...
                    <td><?php echo $row['status'];  ?></td>
                       <td> <a href='../includes/delete_local.php?del=<?php echo $client; ?>&trans_id=<?php echo $row['id']?>' type='button' class='btn btn-danger' style='margin-right: 5px; background: red !important; font-size: 14px'><i class='fas fa-trash-alt'></i> Delete</a></td>
                  </tr> 
                   <?php
                            }
                    else{
