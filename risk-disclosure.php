...
<head>
	...
	<title>Risk Disclosure | FirstPak Bank</title>
	<!-- Bootstrap -->
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<!--<li class="dropdown" style="color: white;">
                            <a href="index-2.php" style="color: white;"> Insurance & Pension</a>
                            <ul class="dropdown-menu" >
                                <li><a  href="#">Life Insurances</a></li>
                                <li><a  href="#">Health Insurances</a></li>
                                <li><a href="#">Personal Pension System</a></li>
                                <li><a href="#">Vehicle Insurances</a></li>
                            </ul>
                        </li>-->
						...
						<div class="col-sm-12 control-sides" style="padding: 10px; background: white;">
							...
							<div class="row">
								...
								<p class="col-md-10 col-md-offset-1" style="margin-top: 15px;">
									This Notice is provided by <strong>FirstPak Bank </strong> trading as <strong>FirstPak Bank</strong> (“we”)
								</p>
								...
								<p class="col-md-10 col-md-offset-1">
									It is your responsibility to monitor your account. FirstPak Bank has the right to liquidate your positions without notice
									in the event of a margin deficiency.
								</p>


								<p class="col-md-10 col-md-offset-1">
									You must monitor your account so that at all times the account contains sufficient equity to meet FirstPak Bank Margin Requirements. <br />
									FirstPak Bank does not have to notify you of any failure to meet Margin Requirements prior to Trading Companies exercising its rights under
								...
								<p class="col-md-10 col-md-offset-1">
									...
									Trading Company systems and services "FirstPak Bank" and our liability to you is limited.
								</p>
