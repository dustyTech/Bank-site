...
<head>
  ...
  <title>Cards | FirstPak Bank</title>
  <!-- Bootstrap -->
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="feature-box-4-grid1 " style="background: transparent;">
                    <div class="feature-box text-center">
                      ...
                      <p class="subtext">Your FirstPak Bank personal checking account includes one of our feature-rich Debit MasterCard® options. </p>
                      <a href="Debit-Cards.php" class="button button-2x primary-bg button-arrow button-radius">Read More &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="feature-box-4-grid1" style="background: transparent;">
                    <div class="feature-box text-center">
                      ...
                      <a href="Mobile-Wallet.php" class="button button-2x primary-bg button-arrow button-radius">Read More &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
