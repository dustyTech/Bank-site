...
<head>
  ...
  <title>About | FirstPak Bank</title>
  <!-- Bootstrap -->
...
<body style=" overflow-x: hidden;">
  ...
  <div class="container-fluid" style=" padding-right:0px; padding-left:0px;">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699;">
          <img src="images/about/about_us_image.png" class="manage-height" data-pagespeed-url-hash="2461754520" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          <div class="holdWriteUp">
            <h3 class="text-center carryTop text_white">
              About FirstPak Bank</h3>
            <p class="text-center carryBottom text_white">
              FirstPak Bank was Established in 2015 with a license of an European broker regulated by the Financial Conduct Authority (FCA), license No. 191/13.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-12" style="margin-top: 20px;">
            <div class="row">
              ...
              <div class="col-md-4 text-center">
                ...
                <h5>Leverage up to <br> <strong>1:500</strong></h5>
                <p>
                  500x higher profit potential. Trade positions 500x your balance.
                </p>
              </div>
              
              <div class="col-md-4 text-center">
                <i class="fa fa-clock-o fa-3x" ></i>
                <h5>Trade with <br> <strong>no expiration</strong> </h5>
                <p>
                  Trade 24 hours, 5 days a week. Find trading opportunities anytime
                </p>
              </div>
              
              <div class="col-md-4 text-center">
                <i class="fa fa-exclamation fa-3x"></i>
                <h5>Trade with <br> <strong>no commission</strong> </h5>
                <p>
                  Minimum deposit 200 EUR Save more with no commission. 
                </p>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="left-content">
                    <img src="images/about/image-content-1.jpg" class="img-responsive" alt="" data-pagespeed-url-hash="3640630981" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                  </div>
                </div>
                <div class="col-sm-6">
    ...
    <!-- Info Box -->
    <div class="container-fluid">
      <div id="theNext" class="info-box section-padding-me row" style="background:url(images/security/security__info-bg.png);background-repeat:no-repeat;background-size:100% 100%;padding-top:0;padding-bottom:50px">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div class="row">
                  ...
                  <div class="white-board">
                    <div class="row">
                      ...
                      <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4  zero-padding-right m-topm">
                        <img src="images/about/Gear-Final.png" class="img-responsive danger" data-pagespeed-url-hash="430590624" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        <img src="images/about/gear-final-life.png" class="img-responsive life" data-pagespeed-url-hash="3978758483" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                      </div>
                ...
                <div class="col-md-6 master" style="margin-top: 20px;">
                  <div class="white-board">
                    <div class="row">
                      ...
                      <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4  zero-padding-right m-topm">
                        <img src="images/about/Scissors-Final.png" class="img-responsive danger" data-pagespeed-url-hash="1637767948" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        <img src="images/about/scissor-final-life.png" class="img-responsive life" data-pagespeed-url-hash="2542378228" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                      </div>
                      <div class="col-md-9 col-sm-9 col-xs-12 zero-padding-left m-topn">
                        <div class="row">
                          <h5 class="col-md-12 zero-padding-left" style="color:#336699; ">
                ...
                <div class="col-md-6 master" style="margin-top: 20px;">
                  <div class="white-board">
                    <div class="row">
                      ...
                      <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4  zero-padding-right m-topm">
                        <img src="images/about/trading-against.png" class="img-responsive danger" data-pagespeed-url-hash="2447756003" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        <img src="images/about/trading-against-life.png" class="img-responsive life" data-pagespeed-url-hash="2218620140" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                      </div>
                      <div class="col-md-9 col-sm-9 col-xs-12 zero-padding-left m-topn">
                        <div class="row">
                          <h5 class="col-md-12 zero-padding-left" style="color:#336699; ">
                ...
                <div class="col-md-6 master" style="margin-top: 20px;">
                  <div class="white-board">
                    <div class="row">
                      ...
                      <div class="col-md-3 col-md-offset-0 col-sm-3 col-sm-offset-3 col-xs-4 col-xs-offset-4 zero-padding-right m-topm">
                        <img src="images/about/battery-danger.png" class="img-responsive danger" data-pagespeed-url-hash="2636494003" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        <img src="images/about/battery-life.png" class="img-responsive life" data-pagespeed-url-hash="4012840880" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                      </div>
    ...
    <!-- Service -->
    <div class="container-fluid">
      <div class="service section-padding row" style="background:#f2f5fb; background:url(images/security/security__footer-bg.png); background-repeat: no-repeat; background-size: cover;">
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-md-offset-3">
              <div class="section-heading text-center">
                ...
                <a href="register.php" class="button button-5x covered_but text_white ">
                  Register
                </a>
              </div>
            </div>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div id="regModal" class="my_modal hideModal rubberBand wow " style="background:url(images/bg_reg.jpg);background-repeat:no-repeat;background-size:cover">
        ...
        <div class="row theModalBody">
          <div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-4 col-xs-offset-4 text-center control-mouse">
            <img src="images/slider/theMouse.png" class="img-responsive" data-pagespeed-url-hash="157342038" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          </div>
      ...
      <div id="signInModal" class="my_modal2 hideModal " style="background:url(images/slider/mobile_slider.png);background-repeat:no-repeat;background-size:cover">
        ...
        <div class="row">
          <div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-2 col-xs-offset-5 text-center control-mouse1">
            <img src="images/slider/lock-open.png" class="img-responsive" data-pagespeed-url-hash="504164648" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          </div>
      ...
      <div id="forGetPass" class="my_modal2 hideModal " style="background:url(images/slider/mobile_slider.png);background-repeat:no-repeat;background-size:cover">
        ...
        <div class="row">
          <div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-2 col-xs-offset-5 text-center control-mouse1">
            <img src="images/slider/frgtPass.png" class="img-responsive" data-pagespeed-url-hash="981396904" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          </div>
